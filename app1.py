...
# -----------------------------------------------------------------------------
st.set_page_config(
    page_title="ANFA Nacimiento Móvil",
    page_icon="⚽",
    layout="wide",
...
st.markdown(
    ...
    */
    ...
    /* Menú horizontal alternativo, oculto en escritorio. */
    .mobile-scroll-nav {
        display: none;
    }
    ...
    @media (max-width: 768px) {
        ...
        */
        ...
        /*
           Menú móvil como cinta horizontal desplazable.
           Cada opción conserva el nombre completo y se mueve con el dedo.
        */
        .mobile-scroll-nav {
            ...
            margin: 0 -.75rem .80rem !important;
            padding: .12rem .75rem .52rem !important;
        ...
        .mobile-scroll-nav .mobile-scroll-item {
            ...
            border: 1px solid rgba(9,42,85,.24) !important;
            ...
            box-shadow: 0 3px 10px rgba(20,45,80,.08) !important;
            -webkit-tap-highlight-color: transparent !important;
        }
        .mobile-scroll-nav .mobile-scroll-item.active {
...
# Menú exclusivo para teléfonos: barra horizontal real y desplazable.
# Se construye con HTML puro para que las reglas de st.columns nunca puedan
# comprimir los nombres ni convertirlos en texto vertical.
mobile_menu_links = []
for mobile_option in MENU_OPTIONS:
    active_class = " is-active" if mobile_option == menu else ""
    aria_current = ' aria-current="page"' if mobile_option == menu else ""
    mobile_menu_links.append(
        f'<a class="anfa-mobile-nav-link{active_class}" '
        f'href="?menu={mobile_option}" target="_self"{aria_current}>'
        f'{html.escape(mobile_option)}</a>'
    )

mobile_menu_html = (
    '<div class="anfa-mobile-nav-shell" aria-label="Menú principal">'
    '<div class="anfa-mobile-nav-track">'
    + "".join(mobile_menu_links)
    + '</div></div>'
)
st.markdown(mobile_menu_html, unsafe_allow_html=True)

# Este bloque va después de todos los estilos anteriores y por eso tiene la
# prioridad final. También oculta cualquier menú móvil antiguo basado en
# st.columns que pudiera haber quedado en el DOM.
st.markdown(
    """
    <style>
    .anfa-mobile-nav-shell {
        display: none !important;
    }

    @media (max-width: 768px) {
        /* Ocultar definitivamente versiones móviles antiguas de Streamlit. */
        .st-key-mobile_navigation_bar,
        [class*="st-key-mobile_navigation_"],
        [class*="st-key-mobile_menu_"],
        [class*="st-key-menu_movil_"] {
            display: none !important;
            visibility: hidden !important;
            height: 0 !important;
            min-height: 0 !important;
        ...
        .anfa-mobile-nav-shell {
            ...
            width: calc(100% + 1.5rem) !important;
            max-width: none !important;
            margin: 0 -.75rem .85rem !important;
            padding: 0 !important;
            overflow: hidden !important;
            box-sizing: border-box !important;
        }

        .anfa-mobile-nav-track {
            display: flex !important;
            flex-direction: row !important;
            flex-wrap: nowrap !important;
            align-items: center !important;
            ...
            max-width: 100% !important;
            margin: 0 !important;
            padding: .18rem .75rem .55rem !important;
            overflow-x: auto !important;
            overflow-y: hidden !important;
            box-sizing: border-box !important;
            white-space: nowrap !important;
        ...
        .anfa-mobile-nav-track::-webkit-scrollbar {
            display: none !important;
            width: 0 !important;
            height: 0 !important;
        }

        .anfa-mobile-nav-link {
            display: inline-flex !important;
            flex: 0 0 auto !important;
            width: auto !important;
        ...
        .anfa-mobile-nav-link.is-active {
            background: #ef4444 !important;
            border-color: #ef4444 !important;
            color: #ffffff !important;
        }

        .anfa-mobile-nav-link:active {
            transform: translateY(1px) !important;
        }
    }
    </style>
